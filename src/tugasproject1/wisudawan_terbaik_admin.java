...
public class wisudawan_terbaik_admin extends javax.swing.JFrame {
    ...
    try {
        ...
        cn.createStatement().executeUpdate("INSERT INTO wisudawan_terbaik (nama_mhs, ipk, tahun, prodi, studi, fakultas) VALUES  ("
        + "'" + nama + "',"
        + "'" + ipk + "',"
        + "'" + tahun + "',"
        + "'" + prodi + "',"
    ...
    try {
        ...
        cn.createStatement().executeUpdate(
            "UPDATE wisudawan_terbaik SET nama_mhs='" + nama + "',ipk='" + ipk + "',tahun='" + tahun + "',prodi='" + prodi + 
            "',studi= '" + studi + "',fakultas='" + fakultas + "' WHERE nama_mhs='" + nama + "'");
