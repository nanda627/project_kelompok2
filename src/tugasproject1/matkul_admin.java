...
public class matkul_admin extends javax.swing.JFrame {
    ...
    public matkul_admin() {
        initComponents();
        String[] judul = {"no","kode MK","Nama matkul", "ruangan", "sks", "jam", "kelas", "hari", "nama dosen"};
    ...
    try (FileWriter pdf = new FileWriter(path))  {
        TableModel model = table.getModel();
        
        for (int i = 0; i < model.getColumnCount(); i++) {
           pdf.write(model.getColumnName(i));
    ...
    try {
        ...
        String dosen = txtdosen1.getText();
         ...
         cn.createStatement().executeUpdate("INSERT INTO mata_kuliah (kodeMK, Nama_matkul, ruangan, sks, jam, kelas, hari, nama_dosen) VALUES  ("
         + "'" + kode + "',"
         + "'" + nama + "',"
         + "'" + ruangan + "',"
         + "'" + sks + "',"
    ...
    try {
          ...
          int confirm = JOptionPane.showConfirmDialog(null, 
                  "apakah yakin ingin menghapus mata kuliah ini: " + nama + "?","konfirmasi hapus",
    ...
    try {
        ...
        cn.createStatement().executeUpdate(
            "UPDATE mata_kuliah SET Nama_matkul='" + nama + "',kodeMK='" + kode + "',ruangan='" + ruangan + "',sks='" + sks + "',jam='" + jam + "',kelas='" + kelas + "',hari='" + hari + "',nama_dosen='" + dosen + "'WHERE Nama_matkul='" + nama + "'");
